...
RELEASE_SOURCE_SHA256 = "2728ca7254fed74060d3d565041704ff1051795ebc6742acf3e4c177a7c05a51"
...
REQUIRED_SCRIPT_CALLS = {
    "main": frozenset({"configure_runtime_environment", "bootstrap_to_desktop", "AnyGameAIApp"}),
    "ensure_files": frozenset({
        "repair_main_script", "ensure_numpy", "runtime_self_check", "repair_profile",
        "verify_main_script_integrity",
    }),
    "record_human_session": frozenset({"ensure_core_ready", "profile_identity", "observe_human_action"}),
    "train_all_profiles": frozenset({"ensure_runtime_ready", "train_model", "refresh_global_prior"}),
    "run_ai_session": frozenset({"ensure_runtime_ready", "profile_identity", "execute_action"}),
}
REQUIRED_APP_CALLS = {
...
def runtime_self_check(np) -> None:
    if (
        ...
        or release_version_tuple(APP_VERSION) < (54, 0, 0)
        or CONFIG_SCHEMA < 25
